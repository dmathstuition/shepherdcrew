    ...
    <section id="testimonies" className="band">
      ...
      <div className="shell">
        <Reveal>
          ...
          <p className="mt-5 max-w-[54ch] text-white/60">
        ...
        <div className="mt-14 gap-4 sm:gap-5 [column-count:1] sm:[column-count:2]">
          {testimonies.map((t, i) => (
            <Reveal key={t.src} delay={i * 80} className="mb-4 break-inside-avoid sm:mb-5">
              <figure className="overflow-hidden rounded-2xl border border-white/10 bg-deep/60">
                <Image
                  src={t.src}
                ...
                />
                <figcaption className="flex items-center gap-2 px-5 py-4 text-xs uppercase tracking-[0.28em] text-white/40">
